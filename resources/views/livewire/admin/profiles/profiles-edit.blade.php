                ...
                <div class="grid grid-cols-2 gap-x-2">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <input type="text" wire:model="form.nama_depan" placeholder="Masukkan nama depan"
                                class="input input-bordered rounded-lg bg-gray-100 text-gray-900 input-primary @error('form.nama_depan') border-red-500 @enderror"
                                autofocus />
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <input type="text" wire:model="form.nama_belakang" placeholder="Masukkan nama belakang"
                                class="input input-bordered rounded-lg bg-gray-100 text-gray-900 input-primary @error('form.nama_belakang') border-red-500 @enderror" />
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <input type="date" wire:model="form.tanggal_lahir"
                                class="input input-bordered rounded-lg bg-gray-100 text-gray-900 input-primary @error('form.tanggal_lahir') border-red-500 @enderror" />
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <input type="tel" wire:model="form.nomor_telepon" placeholder="Masukkan nomor telepon"
                                class="input input-bordered rounded-lg bg-gray-100 text-gray-900 input-primary @error('form.nomor_telepon') border-red-500 @enderror" />
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <select wire:model="form.jenis_kelamin" name="jenis_kelamin" id="jenis_kelamin"
                                class="select select-bordered rounded-lg bg-gray-100 text-gray-900 select-primary @error('form.jenis_kelamin') border-red-500 @enderror">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <select wire:model="form.agama" name="agama" id="agama"
                                class="select select-bordered rounded-lg bg-gray-100 text-gray-900 select-primary @error('form.agama') border-red-500 @enderror">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <select wire:change="changeProvinsi" wire:model="form.provinsi"
                                class="select select-bordered rounded-lg bg-gray-100 text-gray-900 select-primary @error('form.provinsi') border-red-500 @enderror">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <select wire:model="form.kota"
                                class="select select-bordered rounded-lg bg-gray-100 text-gray-900 select-primary @error('form.kota') border-red-500 @enderror">
                ...
                <div class="mb-2">
                    <label class="form-control">
                        ...
                        <textarea wire:model="form.alamat" placeholder="Masukkan alamat"
                            class="textarea textarea-bordered rounded-lg bg-gray-100 text-gray-900 textarea-primary @error('form.alamat') border-red-500 @enderror"></textarea>
                        @error('form.alamat')
                            <span class="error text-red-500">{{ $message }}</span>
                        @enderror
                    </label>
