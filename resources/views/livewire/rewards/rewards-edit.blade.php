<div>
    ...
    <x-dialog-modal wire:model.live="modalRewardEdit" submit="save">
        <x-slot name="title">
            Form Reward
        </x-slot>
        ...
        <x-slot name="content">
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12 mb-4">
                    <x-label for="form.customer" value="Name" />
                ...
                <!-- Month -->
                <div class="col-span-12 mb-4">
                    <x-label for="form.month" value="Name" />
                ...
                <!-- Year -->
                <div class="col-span-12 mb-4">
                    <x-label for="form.year" value="Name" />
